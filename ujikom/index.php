...
<body>
  <section id="navbar">
    <nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
      <div class="container-fluid">
        ...
        <a class="navbar-brand mx-2" href="index.php">Healthier</a>
        ...
        <div
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
            <a class="nav-link" href="https://wa.me/+62895422529758">Kontak Kami</a>
            </li>
          </ul>
  ...
  <section id="jumbotron">
    <div class="container-fluid py-5 jumbotron-bg text-center">
      ...
      <h1 class="display-3 fw-bold">Healthier</h1>
      <p>
      <h4>Your One-Stop Marketplace for Quality Medical Tools and Equipment</h4>
      </p>
    </div>
  </section>
  ...
  <section id="solusi" class="container py-5 my-5">
    <div class="row text-center ">
      <div class="col-12 p-5">
        <h2 class="display-4">Solusi Terbaik dari Healthier</h2>
      </div>

...
$htmlContent = '<center><h4>Bukti Pembelian Alat Kesehatan Healthier</h4></center><hr/><br/><br/><br/>';
...
$mail->Username   = 'admhealthier@gmail.com';                     //SMTP username
$mail->Password   = 'mkikrltztqctkmgk';                               //SMTP password
$mail->SMTPSecure = 'ssl';            //Enable implicit TLS encryption
$mail->Port       = 465;

//Pengirim
$mail->From = $mail->Username;
$mail->FromName = "Admin Healthier";

//Penerima
$mail->setFrom($email, "Healthier");
$mail->addAddress($email);
$mail->isHTML(true);
$mail->Subject = "Bukti Transaksi Healthier";
